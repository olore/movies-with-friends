<template>
  <div class="pa-1">
    ...
    <v-row>
      <v-col cols="12">
        <v-row>
          <Card :movie="movie2" tile class="ma-1 pa-1" />
          <Card :movie="movie3" tile class="ma-1 pa-1" />
          <Card :movie="movie" tile v-for="n in 7" :key="n" class="ma-1 pa-1" />
        </v-row>
      </v-col>
    </v-row>
  </div>
...
export default {
  ...
  data: () => ({
    ...
    movie3: new Movie({
      ...
      Language: "English",
      Country: "USA",
      Awards: "Nominated for 1 Golden Globe. Another 2 wins & 49 nominations.",
      Poster:
